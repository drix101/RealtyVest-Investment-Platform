...
export const PropertiesPage = () => {
  ...
  const filteredProperties = activeFilter === 'all' ? properties : properties.filter(property => property.type === activeFilter);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white p-3 rounded-lg shadow-lg flex flex-col gap-3">
            <div className="relative">
              ...
              <input type="text" placeholder="Search properties..." className="w-full pl-10 pr-4 py-2 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md font-medium flex items-center justify-center transition">
              Search Properties
            </button>
          </div>
        </div>
