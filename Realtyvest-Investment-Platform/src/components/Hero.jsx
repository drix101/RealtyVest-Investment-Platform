  ...
  return (
    <section className="relative bg-blue-800 text-white">
      ...
      <div
        ...
        style={{ backgroundImage: "url(/images/Realty-bg.png)" }}
      ></div>
      <div className="container mx-auto px-4 py-16 md:py-20 lg:py-32 relative z-10">
        <div className="max-w-3xl">
          ...
          <form className="bg-white p-4 rounded-lg shadow-lg" onSubmit={handleSearch}>
            <div className="flex flex-col space-y-3 md:flex-row md:space-y-0 md:gap-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-black bg-white placeholder-gray-500"
                  value={searchTerm}
              ...
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md font-medium flex items-center justify-center transition w-full md:w-auto"
              >
